...
public class SearchPageAdapter extends FragmentStateAdapter {
    ...
    public SearchPageAdapter(FragmentActivity fa, List<String> bookName, List<String> authors, List<String> imageUrls, List<String> isbn13, OnItemClickListener onItemClickListener) {
        super(fa);
    ...
    public Fragment createFragment(int position) {
        ...
        return LatelySearchImageFragment.newInstance(bookName.get(index), authors.get(index), imageUrls.get(index), isbn13.get(index), onItemClickListener);
    }
