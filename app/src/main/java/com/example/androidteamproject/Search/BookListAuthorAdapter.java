...
public class BookListAuthorAdapter extends BaseAdapter {
    private Context context;
    private List<SearchBookAuthor> books;

    public BookListAuthorAdapter(Context context, List<SearchBookAuthor> books) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SearchBookAuthor book = books.get(position);
