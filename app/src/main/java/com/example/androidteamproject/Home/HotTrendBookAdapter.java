...
public class HotTrendBookAdapter extends FragmentStateAdapter {
    ...
    public HotTrendBookAdapter(FragmentActivity fa, List<String> class_nm, List<String> bookName, List<String> authors, List<String> imageUrls) {
        super(fa);
    ...
    public Fragment createFragment(int position) {
        ...
        return HotTrendBookImageFragment.newInstance(class_nm.get(index), bookName.get(index), authors.get(index), imageUrls.get(index));
    }
