...
public class ReaderBookAdapter extends FragmentStateAdapter {
    ...
    public ReaderBookAdapter(FragmentActivity fa, List<String> bookNames, List<String> imageUrls, List<String> isbn13s) {
        super(fa);
    ...
    public Fragment createFragment(int position) {
        ...
        return ReaderBookImageFragment.newInstance(bookNames.get(index), imageUrls.get(index), isbn13s.get(index));
    }
