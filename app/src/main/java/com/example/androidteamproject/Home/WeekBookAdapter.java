...
public class WeekBookAdapter extends FragmentStateAdapter {
    ...
    public WeekBookAdapter(FragmentActivity fa, List<String> bookName, List<String> imageUrls) {
        super(fa);
    ...
    public Fragment createFragment(int position) {
        ...
        return WeekBookImageFragment.newInstance(bookName.get(index), imageUrls.get(index));
    }
