...
public class WeekBookAdapter extends FragmentStateAdapter {
    ...
    public WeekBookAdapter(FragmentActivity fa, List<String> class_nm, List<String> bookName, List<String> authors, List<String> imageUrls, List<String> isbn13, OnItemClickListener onItemClickListener) {
        super(fa);
    ...
    public Fragment createFragment(int position) {
        ...
        return WeekBookImageFragment.newInstance(class_nm.get(index), bookName.get(index), authors.get(index), imageUrls.get(index), isbn13.get(index), onItemClickListener);
    }
