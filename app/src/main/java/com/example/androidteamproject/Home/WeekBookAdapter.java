...
public class WeekBookAdapter extends FragmentStateAdapter {
    ...
    public WeekBookAdapter(FragmentActivity fa, List<String> bookName, List<String> authors, List<String> imageUrls) {
        super(fa);
    ...
    public Fragment createFragment(int position) {
        ...
        return WeekBookImageFragment.newInstance(bookName.get(index), authors.get(index), imageUrls.get(index));
    }
